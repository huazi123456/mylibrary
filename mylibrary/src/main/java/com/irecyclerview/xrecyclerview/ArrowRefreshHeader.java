...
public class ArrowRefreshHeader extends LinearLayout implements BaseRefreshHeader {
    ...
    private SimpleDateFormat formatter = new SimpleDateFormat("MM月dd日 HH时mm分");
    ...
    private void initView() {
        // 初始情况，设置下拉刷新view高度为0
        mContainer = (LinearLayout) LayoutInflater.from(getContext()).inflate(R.layout.header_recycleview_loading, null);
            ...
            case STATE_NORMAL:
                if (mState == STATE_RELEASE_TO_REFRESH) {
                    ...
                    if(mRefreshStateListener != null) {
                        mRefreshStateListener.startPull();
                    }
                }
    ...
    public void refreshComplete() {
        mHeaderTimeView.setText(formatter.format(new Date()));
        setState(STATE_DONE);
    ...
    public void setRefreshListener(RefreshStateListener listener) {
        this.mRefreshStateListener = listener ;
    }
