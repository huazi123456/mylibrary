package com.irecyclerview.stickyheadersrecyclerview.util;
...
import com.irecyclerview.stickyheadersrecyclerview.ItemVisibilityAdapter;
import com.irecyclerview.stickyheadersrecyclerview.StickyRecyclerAdapter;
import com.irecyclerview.stickyheadersrecyclerview.caching.HeaderProvider;
import com.irecyclerview.stickyheadersrecyclerview.caching.HeaderViewCache;
...
public class StickyRecyclerHeadersDecoration extends RecyclerView.ItemDecoration {
    ...
    public StickyRecyclerHeadersDecoration(StickyRecyclerAdapter adapter) {
        this(adapter, new LinearLayoutOrientationProvider(), new DimensionCalculator(), null);
    }

    public StickyRecyclerHeadersDecoration(StickyRecyclerAdapter adapter, ItemVisibilityAdapter visibilityAdapter) {
        this(adapter, new LinearLayoutOrientationProvider(), new DimensionCalculator(), visibilityAdapter);
    }

    private StickyRecyclerHeadersDecoration(StickyRecyclerAdapter adapter, OrientationProvider orientationProvider,
    ...
    private StickyRecyclerHeadersDecoration(StickyRecyclerAdapter adapter, HeaderRenderer headerRenderer,
