...
/**
 * RecyclerView 通用自定义ViewHolder
 * Created by zhengjiabin on 2016/5/11.
 */
public class BaseViewHolder extends RecyclerView.ViewHolder {
     ...
     */
    public static BaseViewHolder get(Context context, ViewGroup parent, int itemLayoutId) {

        Log.d("BaseViewHolder","context = " + context.getClass().getSimpleName() +
             "，ViewGroup = " + parent.getClass().getSimpleName() +
        ...
        try {
            ...
            holder.mItemLayoutId = itemLayoutId;
            return holder;
