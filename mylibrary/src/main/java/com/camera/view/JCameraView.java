...
//                    Log.i("CJT", "result = " + (result - firstTouchLength));
    ...
    public void setJCameraListener(JCameraListener jCameraLisenter) {
    ...
    //启动Camera错误回调
    public void setErrorListener(ErrorListener errorLisenter) {
    ...
    public boolean handlerFoucs(float x, float y) {
        ...
        int fWidth = mFoucsView.getWidth();
        int fHeight = mFoucsView.getHeight();
